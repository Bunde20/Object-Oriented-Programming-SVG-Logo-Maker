// Imports required shape classes
const {Circle, Triangle, Square} = require("./shapes")

// Test for circle class with example colors
...
// Test for triangle class with example colors
...
// Test for square class with example colors
